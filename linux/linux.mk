...
LINUX_KCONFIG_DEFCONFIG_TEMP = $(KERNEL_ARCH_PATH)/configs/__buildroot_defconfig

define LINUX_KCONFIG_DEFCONFIG_CMDS
	$(INSTALL) -m 0644 $(LINUX_KCONFIG_FILE) $(LINUX_KCONFIG_DEFCONFIG_TEMP)
	$(LINUX_MAKE_ENV) $(MAKE) $(LINUX_MAKE_FLAGS) -C $(LINUX_DIR) __buildroot_defconfig
	rm -f $(LINUX_KCONFIG_DEFCONFIG_TEMP)
endef
