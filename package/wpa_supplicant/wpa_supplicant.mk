...
# 28.04.2022 F&S:
# wpa_supplicant is part of project hostap that also contains hostapd. There
# are separate release tar files for hostapd and wpa_suppliant, but there is
# only one git. The Silex version "2.10-devel sxa 1.0.0.a19" is based on an
# early developer version of 2.10 and was most probably branched off at commit
